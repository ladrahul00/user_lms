...
type UserService interface {
	Create(ctx context.Context, in *NewUserRequest, opts ...client.CallOption) (*Response, error)
	...
	Update(ctx context.Context, in *UpdateUserRequest, opts ...client.CallOption) (*Response, error)
}
...
func (c *userService) Create(ctx context.Context, in *NewUserRequest, opts ...client.CallOption) (*Response, error) {
...
func (c *userService) Update(ctx context.Context, in *UpdateUserRequest, opts ...client.CallOption) (*Response, error) {
...
type UserHandler interface {
	Create(context.Context, *NewUserRequest, *Response) error
...
func RegisterUserHandler(s server.Server, hdlr UserHandler, opts ...server.HandlerOption) error {
	type user interface {
		Create(ctx context.Context, in *NewUserRequest, out *Response) error
		...
		Update(ctx context.Context, in *UpdateUserRequest, out *Response) error
	}
	type User struct {
		user
	}
...
func (h *userHandler) Create(ctx context.Context, in *NewUserRequest, out *Response) error {
...
func (h *userHandler) Update(ctx context.Context, in *UpdateUserRequest, out *Response) error {
