...
proto:
	...
	protoc --proto_path=. --micro_out=${MODIFY}:. --go_out=${MODIFY}:. proto/organization/organization.proto
	protoc --proto_path=. --micro_out=${MODIFY}:. --go_out=${MODIFY}:. proto/source/source.proto
